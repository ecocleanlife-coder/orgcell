...
const s = {
  ...
  warningIcon: { fontSize: 14, flexShrink: 0 },
  warningText: {
    fontSize:   11,
    color:      '#C4A882',
    lineHeight: 1.5,
  ...
  logo:    { fontSize: 13, fontWeight: 700, color: '#C4A882' },
  copy:    { fontSize: 11, color: '#7a6a55' },
  ...
  linkA: { color: '#9a8a75', fontSize: 11, textDecoration: 'underline' },
  sep:   { color: '#5a4a35', fontSize: 11 },
  ...
  minimalText: { fontSize: 11, color: '#9a8a75' },
  minimalLink: {
    background:    'none',
    border:        'none',
    color:         '#C4A882',
  ...
  modalTitle: { fontSize: 16, fontWeight: 700, color: '#3a2a1a', margin: 0, flex: 1 },
  modalClose: {
