...
function makeNode(person, x, y, depth, role, coupleId, coupleRole, coupleBlockX, opacity, animOrder) {
  return {
    ...
    nameEnMiddle: person.name_en_middle || null,
    ...
    birthLunar:   person.birth_lunar || null,
    deathLunar:   person.death_lunar || null,
    isDeceased:   person.is_deceased || false,
    photoUrl:     person.photo_url   || null,
    bio1:         person.bio1        || null,
    bio2:         person.bio2        || null,
    bio3:         person.bio3        || null,
    nameLegalLast:  person.name_legal_last  || null,
    nameLegalFirst: person.name_legal_first || null,
    nameOther:      person.name_other       || null,
